...
**Fetching latest versions**: `curl https://get.greycat.io/files/<lib>/stable/latest` — returns `<lib>/<ver>/<lib>-<ver>` (use the part after `/`). Exception: `std` uses `core` as the URL path.
