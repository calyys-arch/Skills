...
The GreyCat VM bytecode instruction set. Used internally by the interpreter.
 ...
 Full opcode list (85 opcodes, 0-84) 
...
On WASM targets, provides standalone implementations of standard math functions and constants (since ` ` is unavailable). On native targets, simply includes ` ` and ` `.
