...
**Rules:**
1. ` ` = the GCL module name (from the file's module path), using underscores as-is
2. ` ` = the GCL type name **exactly as written** (PascalCase preserved)
3. `__` (double underscore) separates the type from the method name
4. ` ` = the GCL method name **exactly as written** (camelCase preserved)
